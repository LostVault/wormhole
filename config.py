...
client_full_description = 'Приложение создано для обмена текстовыми и файловыми сообщениями между серверами по игре ' \
                          '[Elite ' \
                   ...
                   'данного приложения сделать свою сеть обмена сообщениями например по торговле или другой игре. ' \
                          'Техническая поддержка: https://discord.gg/HFqmXPvMxC '

# Сообщение для описания канала которое создаётся по команде Setup
channel_setup_description = '**Vox Galactica** - Wormhole / Глобальный чат серверов по Elite Dangerous'

globalchannel_rules = '''1. Не оскорблять участников канала
2. Не использовать матерные выражения в сообщениях только в рамках разумного
3. Не спамить
4. Не флудить
5. Никакого nsfw'''

additional_owners: list = [478527700710195203,  # Politruk#6666
