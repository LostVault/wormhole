...
- Блокировка распространяется не только на простых участников глобального чата но и на модерацию в случае, если модерацию не заблокировала пользователя по причине дружбу, хороших отношений и т.д. (За нарушение должен быть наказн каждый, не зависимо от статуса)
```
'''
