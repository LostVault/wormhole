...
globalchannel_rules = '''```Запрещено притеснять, оскорблять или издеваться над участниками глобального чата.``` ```Запрещено использовать чрезмерное количества сообщений, изображений, эмодзи, команд.``` ```Запрещено поднимать темы касающиеся политики или религии. Эти сложные темы приводят к неоднозначным и оскорбительным сообщениям.```  ```Запрещено распространять пиратский, сексуальный, NSFW или контент иного подозрительного содержания.``` ```Запрещено распространять любую информацию личного характера. Защитите свою конфиденциальность и конфиденциальность других.``` ```Запрещена реклама любого характера. Сюда входят нежелательные ссылки на социальные сети, серверы, сообщества и службы в чате или прямых сообщениях.``` ```Рекомендуется не использоваться сообщения с матерными словами или использоваться мат в редких и исключительных случаях.``` ```diff\n- Блокироваться за нарушение правил будут все участники которые были в них замечены, включая того кто попытался ответить своему обидчику его же методами.\n- Блокировка распространяется не только на простых участников глобального чата но и на модерацию в случае, если модерацию не заблокировала пользователя по причине дружбу, хороших отношений и т.д. (За нарушение должен быть наказан каждый, не зависимо от статуса) ``` '''
