...
globalchannel_rules = '```Запрещено притеснять, оскорблять или издеваться над участниками глобального чата.``` ' \
                      ...
                      '```Рекомендуется не использоваться сообщения с матерными словами или использоваться мат в ' \
                      'редких и исключительных случаях.``` ```diff\n- Блокироваться за нарушение правил будут все ' \
                      'участники которые были в них замечены, включая того кто попытался ответить своему обидчику его '\
                      'же методами.\n- Блокировка распространяется не только на простых участников глобального чата ' \
                      'но и на модерацию в случае, если модерацию не заблокировала пользователя по причине дружбу, ' \
                      'хороших отношений и т.д. (За нарушение должен быть наказан каждый, не зависимо от статуса) ``` '
